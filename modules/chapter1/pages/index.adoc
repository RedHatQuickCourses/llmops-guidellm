...
* Python library: Not yet in current upstream documentation. You can see an example here in this guide: https://redhatquickcourses.github.io/genai-vllm/genai-vllm/1/rhoai_deploy/guide_llm.html[,window="_blank"].
* Kubernetes job: https://github.com/rh-aiservices-bu/guidellm-pipeline[,window="_blank"]
* Tekton pipeline: https://github.com/jhurlocker/guidellm-pipeline.git[,window="_blank"] (forked from above repo)
...
* Peruse the available GuideLLM https://github.com/neuralmagic/guidellm?tab=readme-ov-file#configurations[configuration options,window="_blank"]. 
...
Using these profiles, we can map specific input/output token scenarios to real-world use cases to make these runs more explainable to how this impacts applications.
...
nding directory for the chapter accordingly.
